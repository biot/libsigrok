...
struct sr_output {
	...
	const struct sr_output_module *format;
...
struct sr_output_module {
	/**
	 * A unique ID for this output format, suitable for use in command-line
	...
	/**
	 * A unique name for this output format, suitable for use in GUI
